...
EXTERN(void) jpeg_memory_dest JPP((j_decompress_ptr cinfo, void* data, unsigned long len));
EXTERN(void) jpeg_memory_src JPP((j_decompress_ptr cinfo, void* data, unsigned long len));
